...
|---|---|---|---|
| Response field confidence type | number | giữ nguyên number (0..1) | team-vision + team-analytics |

## Xác nhận

- Provider representative: team-vision delegate
- Consumer representative: team-analytics delegate
